...
export default function LeftSidebar({
  ...
  const sidebarLinkCSS =
    'flex items-center gap-4 rounded-full hover:bg-[#171818] py-2.5 px-3 duration-200';
      ...
      >
        ...
        >
          ...
          <div className={sidebarTabCSS}>
            ...
            <h2 className={sidebarTabHeaderCSS}>Lists</h2>
          </div>
          <div className={sidebarTabCSS}>
            <svg
              viewBox="0 0 24 24"
            ...
            <h2 className={sidebarTabHeaderCSS}>Bookmarks</h2>
          </div>
          <div className={sidebarTabCSS}>
            <svg
              viewBox="0 0 24 24"
            ...
            <h2 className={sidebarTabHeaderCSS}>Communities</h2>
          </div>
          <div className={sidebarTabCSS}>
            <svg
              viewBox="0 0 24 24"
            ...
            <h2 className={sidebarTabHeaderCSS}>Verified</h2>
          </div>
          <Link href={`/user/${userNickname}`} className={sidebarLinkCSS}>
            <svg
              viewBox="0 0 24 24"
              aria-hidden="true"
              height={28}
          ...
          <div className={sidebarTabCSS}>
            ...
            <h2 className={sidebarTabHeaderCSS}>More</h2>
          </div>
          ...
          >
            ...
            <h2 className="hidden xl:block text-white">Tweet</h2>
          </button>
        ...
        <section className="flex flex-col items-center">
          ...
          >
            ...
            <div className="hidden xl:block">
              ...
              <h4 className="text-sm text-start text-[#71767b] select-none">
