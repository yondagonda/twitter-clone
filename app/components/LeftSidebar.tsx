...
export default function LeftSidebar({
  ...
  return (
    <div
      className=" h-full bg-transparent text-white flex flex-col items-end xl:items-start 
      leftsidebar min-w-[60px] sm:min-w-[10%] pr-1.5 xl:pl-10 xl:mr-36 2xl:mr-40"
    >
      <div
        className="flex xl:pr-14 flex-col justify-between h-full items-end 
      fixed"
      >
        <div
