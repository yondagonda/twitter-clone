          ...
          return (
            ...
            >
              ...
              >
                <div className="flex gap-1 flex-col  w-full pr-3">
                  <div className="pr-0.5">
                    <div className="flex gap-0.5 items-center">
                      ...
                      <div className="text-[#71767b] break-all truncate text-[15.2px]">
                    ...
                    {tweet.image.imageId !== '' && (
                      <button
                        ...
                        className="max-w-[60%] mt-2 relative"
                      >
                        <Image
                          width={0}
                          height={0}
                ...
                <button
                  className="h-fit group selected p-2 hover:bg-[#02111b] rounded-full duration-200 absolute
                  right-1.5 top-1.5"
                  onClick={(e) => {
                    e.preventDefault();
